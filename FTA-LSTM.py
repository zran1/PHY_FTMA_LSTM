...
def attention_3d_block(inputs):
    ...
    a1 = Permute((2, 1), name='attention_vec')(a1)
    a2 = Dense(input_dim, activation='softmax', name='attention_vec2')(inputs)


    a_probs = Multiply(name='he')([a1, a2])
...
plt.savefig(r"D:\Pycharm\0对比.png",dpi=300)
train.to_excel(r"D:\Pycharm\FTA-LSTM训练结果.xlsx")
result.to_excel(r"D:\Pycharm\FTA-LSTM预测结果.xlsx")
